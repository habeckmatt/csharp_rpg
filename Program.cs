...
namespace rpg
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("You walk into the hallway and see a light coming from under " +
                    "a door down the hall. You walk towards it. Do you open it or knock ? ");
            }

            // Ask user open or knock question
            ...
            else if (doorChoice == "OPEN")
            {
                ...
                switch (keyChoice)
                {
                    case "1":
                        ...
                        Console.WriteLine("The door swings open and NOTHING is there. ");
